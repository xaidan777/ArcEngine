...
const I18N = {
    ...
    STRINGS: {
        en: {
            ...
            "ws.rig": "Rig",
            "ws.anim": "Animation",
            "dock.hierarchy": "Hierarchy",
            "dock.console": "Console",
            "console.clear": "Clear",
            "obj.groundMaterials": "Edit terrain material →",
            "map.new": "+ New map",
            "map.saveAs": "Save as…",
        ...
        ru: {
            "tab.terrain": "Ландшафт",
            "ws.level": "Карта",
            "ws.rig": "Скелет",
            "ws.anim": "Анимация",
            "dock.hierarchy": "Иерархия",
            "dock.console": "Консоль",
            "console.clear": "Очистить",
            "obj.groundMaterials": "Материал ландшафта →",
            "map.new": "+ Новая карта",
            "map.saveAs": "Сохранить как…",
            "map.delete": "Удалить карту",
            "map.clear": "Очистить карту…",
            "map.marker": "+ Маркер",
            "map.enemy": "+ Враг",
            "map.loot": "+ Лут",
            "map.noEnemies": "🕊️ Без врагов",
            "map.save": "Сохранить карту",
            "map.play": "▶ Играть",
